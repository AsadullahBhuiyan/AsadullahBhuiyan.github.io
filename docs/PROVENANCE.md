...
- At the user's request, the Research page's neural-network, topological-quantum, and bosonic contribution bullets now follow page 2 of the supplied `CV_Asad_Stat_Phys_Learning.pdf` (SHA-256 `d61983aa0e5ae383771e366038384c95c98f18fe510f45f9c52f48212eb5a065`). They emphasize concrete research actions, results, methods, and tools. Writing/meeting duties and additional technical contribution details absent from that CV were removed from these lists; the surrounding project explanations and distinctions remain.
